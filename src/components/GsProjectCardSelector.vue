  ...
  >
    ...
    <div class="content-wrapper">
      ...
      <header class="card-header">
        <GsTypography variant="title-2" bold>{{ title }}</GsTypography>
        <GsTags
      ...
      <div class="content-section">
        ...
        <GsTypography variant="body" v-html="description" />
      </div>
      ...
      <footer class="card-footer">
        <div class="location-wrapper">
          <div class="location-icon">
            ...
            <svg v-else width="16" height="20" viewBox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path fill-rule="evenodd" clip-rule="evenodd" d="M8 0C11.7371 0 16 2.89412 16 8.41177C16 12.0824 13.3371 15.9529 8 20C2.66286 15.9529 0 12.0824 0 8.41177C0 2.89412 4.26286 0 8 0Z" fill="#1A975B"/>
              <path d="M11 7.41891C11 6.9672 10.7375 6.56786 10.3381 6.33218C10.5181 6.13579 10.625 5.88866 10.625 5.61861C10.625 4.98524 10.0381 4.47297 9.3125 4.47297C9.29375 4.47297 9.275 4.47461 9.25625 4.47624C9.29187 4.3715 9.3125 4.26184 9.3125 4.14564C9.3125 3.51227 8.72562 3 8 3C7.27437 3 6.6875 3.51227 6.6875 4.14564C6.6875 4.26021 6.70812 4.3715 6.74375 4.47624C6.725 4.47624 6.70625 4.47297 6.6875 4.47297C5.96188 4.47297 5.375 4.98524 5.375 5.61861C5.375 5.88866 5.48375 6.13742 5.66188 6.33218C5.2625 6.56786 5 6.96556 5 7.41891C5 7.87226 5.2625 8.26996 5.66188 8.50563C5.48188 8.70203 5.375 8.94916 5.375 9.2192C5.375 9.85258 5.96188 10.3648 6.6875 10.3648H9.3125C10.0381 10.3648 10.625 9.85258 10.625 9.2192C10.625 8.94916 10.5162 8.70039 10.3381 8.50563C10.7375 8.26996 11 7.87226 11 7.41891Z" fill="white"/>
              <path d="M8.36 12.7871V10.3648H8.12H7.88V12.7871C7.88 13.014 7.88 12.9998 8.12 12.9998C8.36 12.9998 8.36 13.014 8.36 12.7871Z" fill="white"/>
            </svg>
          </div>
          <GsTypography variant="body" v-html="location" />
        </div>
        <GsButton
          v-if="readMoreVariant === 'text'"
          type="link"
          aria-hidden="true"
          tabindex="-1"
        >
        ...
        <div
          ...
          tabindex="-1"
        >
          <img src="/public/chevron_right.svg" alt="Chevron right" class="chevron-icon" />
        </div>
      </footer>
    </div>
  </article>
