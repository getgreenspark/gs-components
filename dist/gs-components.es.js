...
const bs = /* @__PURE__ */ He(_d, [["render", xd], ["__scopeId", "data-v-7750213e"]]), Cd = ["aria-disabled", "aria-label"], Sd = /* @__PURE__ */ pe({
  ...
  setup(e, { emit: t }) {
    const { t: n } = of(), r = e, i = N(() => r.presets.findIndex((c) => c.value === r.modelValue)), o = K(!1), s = t;
    function a(c) {
...
}), Md = /* @__PURE__ */ He(Fd, [["__scopeId", "data-v-f95f2067"]]), Dd = {
  dark: !1,
  colors: {
    primary: "#3B755F",
    secondary: "#E57066",
